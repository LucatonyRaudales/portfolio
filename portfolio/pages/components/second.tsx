...
const Second = () => {
  ...
  return (
    <div className="snap-start h-screen w-screen flex">
      ...
      <div className="snap-y snap-mandatory overflow-y-scroll w-1/2 h-screen ">
...
const TechDescriptionComponent = ({
  image,
  subTitle,
  description,
  title,
  ...
  return (
    <div className="snap-start h-screen w-full flex flex-col items-center justify-center text-center">
      ...
      <div className="text-white font-bold text-2xl mt-8  uppercase">{title}</div>
...
interface TechDescriptionInterface {
  title: string;
